;;; my-doom-oceanic-next-theme.el --- inspired by Oceanic Next -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup my-doom-oceanic-next-theme nil
  "Options for the `my-doom-oceanic-next' theme."
  :group 'doom-themes)

(defcustom my-doom-oceanic-next-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'my-doom-oceanic-next-theme
  :type 'boolean)

(defcustom my-doom-oceanic-next-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'my-doom-oceanic-next-theme
  :type 'boolean)

(defcustom my-doom-oceanic-next-comment-bg my-doom-oceanic-next-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'my-doom-oceanic-next-theme
  :type 'boolean)

(defcustom my-doom-oceanic-next-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme my-doom-oceanic-next
  "A dark theme inspired by Oceanic Next "

  ;; name        default   256       16
  ; Using doom-one background instead
  ((bg         '("#282c34" nil       nil            ))
   ...
   (selection      base2)
   (builtin        red)
   (comments       (if my-doom-oceanic-next-brighter-comments dark-cyan base3))
   (doc-comments   (doom-lighten (if my-doom-oceanic-next-brighter-comments dark-cyan base3) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       violet)
   (methods        blue)
   ...
   (-modeline-bright my-doom-oceanic-next-brighter-modeline)
   (-modeline-pad
    (when my-doom-oceanic-next-padded-modeline
      (if (integerp my-doom-oceanic-next-padded-modeline) my-doom-oceanic-next-padded-modeline 4)))
  ...
  (
   ...
   ((font-lock-comment-face &override)
    :background (if my-doom-oceanic-next-comment-bg (doom-lighten bg 0.05) 'unspecified))
...
;;; my-doom-oceanic-next-theme.el ends here
